...
// 루트 경로 index.html 가져오기
router.get("/", (req, res) => {
  res.sendFile(__dirname + "../public/index.html");
});

// JSON 경로 data.json 가져오기
...
module.exports = {
  handleRootRequest: router.get("/"),
  handleDataRequest: router.post("/send"),
  handleJsonStyleRequest: router.get("/json-style"),
  handleJsonDataRequest: router.get("/json-data"),
};
